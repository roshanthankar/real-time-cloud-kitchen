...
function updateCart(delish) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', delish).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var delish = JSON.parse(btn.dataset.delish);
    updateCart(delish);
  });
});
...
__webpack_require__(/*! /Users/roshanthankar/Documents/Cloud Kitchen/delishkitchen/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/roshanthankar/Documents/Cloud Kitchen/delishkitchen/resources/scss/app.scss */"./resources/scss/app.scss");
